...
Route::resource('categories', 'BooksController@showcategories');
Route::get('create', 'BooksController@formCreate');
//Route::get('basicValidate', 'BooksController@create');
Route::get('read', 'BooksController@read');
Route::any('update/{id}', 'BooksController@update');
Route::get('delete/{id}', 'BooksController@delete');
Route::get('myPagination', 'BooksController@myPagination');
